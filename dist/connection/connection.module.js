...
const mariadb_connection_repository_1 = require("./repositories/mariadb-connection.repository");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            connection_service_1.ConnectionService,
            {
                ...
                useClass: mariadb_connection_repository_1.MariaDbConnectionRepository,
            },
        ],
