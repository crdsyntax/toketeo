    ...
    <div className="h-full overflow-auto p-4 space-y-6">
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-[var(--ch-text-10)] text-muted-foreground">Step-by-step guided setup</p>
        </div>
        ...
        <div className="space-y-2">
          {FAQS.map((faq, i) => (
            <details key={i} className="group rounded-lg border border-border bg-muted/20">
              ...
              <p className="text-[var(--ch-text-11)] text-muted-foreground px-3 pb-2 leading-relaxed">{faq.a}</p>
            </details>
          ))}
        </div>
      </section>
