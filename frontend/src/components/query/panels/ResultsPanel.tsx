import { ChevronUp, Table2, Clock, Save, Maximize2, Download, AlertCircle, X, ArrowUp, ArrowDown, ArrowUpDown, CheckCircle2, ChevronLeft, ChevronRight, Trash2 } from 'lucide-react';
...
export function ResultsPanel({
  ...
  return (
    <div className="border border-border rounded-none bg-card flex flex-col overflow-hidden h-full w-full">
      <div className="p-2 border-b border-border bg-muted/20 flex justify-between items-center px-4 text-left shrink-0">
